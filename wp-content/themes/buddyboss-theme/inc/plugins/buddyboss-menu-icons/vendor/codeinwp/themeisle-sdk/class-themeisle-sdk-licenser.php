 ...
 */
if ( ! class_exists( 'BuddyBoss_SDK_Licenser' ) ) :
	/**
	 * Class BuddyBoss_SDK_Licenser
	 *
	...
	class BuddyBoss_SDK_Licenser {
		...
		/**
		 * @var BuddyBoss_SDK_Product $product The BuddyBoss Product.
		 */
		private $product;
		/**
		...
		/**
		 * BuddyBoss_SDK_Licenser constructor.
		 *
		 * @param BuddyBoss_SDK_Product $product The product object.
		 */
